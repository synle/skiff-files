...
use commands::{
    ...
    fs_compress_zip, fs_create_empty_file, fs_disk_space, fs_extract_zip, fs_hash_sha256,
    fs_image_exif, fs_mounts, fs_open_in_terminal, fs_open_with_default, fs_read_text,
