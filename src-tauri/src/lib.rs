...
use commands::{
    ...
    fs_open_with_default, fs_read_text, fs_remove, fs_rename, fs_reveal_in_os, fs_stat, fs_trash,
    fs_trash_many, get_app_version, settings_load, settings_save, ssh_config_hosts, sync_cancel,
    sync_cpstamp, sync_dedup,
