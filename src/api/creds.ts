...
export const credsStore = (connectionId: string, kind: SecretKind, secret: string): Promise<void> =>
 ...
 *  other error rejects. */
export const credsLoad = (connectionId: string, kind: SecretKind): Promise<string | null> =>
...
export const credsDelete = (connectionId: string, kind: SecretKind): Promise<void> =>
  invoke<void>("creds_delete", { connectionId, kind });
...
export const credsCapable = (): Promise<boolean> => invoke<boolean>("creds_capable");
